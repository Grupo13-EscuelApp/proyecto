...
class _ChatPadresState extends State<ChatPadres> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('$nombreAlumno $apellidoAlumno'),
          centerTitle: true,
          leading: Builder(
            builder: (BuildContext context) {
              return IconButton(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                onTap: () {
                  // Agregar funcionalidad para Eventos
                },
              ),
              ListTile(
                title: const Text('Información', style: TextStyle(color: Colors.white)),
                onTap: () {
                  // Agregar funcionalidad para Información
                },
              ),
              ListTile(
                title: const Text('Ajustes', style: TextStyle(color: Colors.white)),
                onTap: () {
                  // Agregar funcionalidad para Ajustes
                },
              ),
              ListTile(
