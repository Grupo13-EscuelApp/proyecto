...
void main() {
  testWidgets('DescansoDoc UI Test', (WidgetTester tester) async {
    ...
    expect(find.text('Añadir Deposición'), findsOneWidget);

    // Simula la entrada de datos en el diálogo de añadir
    await tester.enterText(find.byType(TextField).at(0), '08:00 - 10:00');
    await tester.enterText(find.byType(TextField).at(1), '2 horas');
    ...
    // Verifica si el descanso añadido se muestra correctamente
