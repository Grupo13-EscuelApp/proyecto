...
void main() {
  testWidgets('P0_Docente UI Test', (WidgetTester tester) async {
    // Construye el widget bajo prueba
    await tester.pumpWidget(MaterialApp(
      home: P0_Docente(Usuario("", "", "")),
    ));

    // Verifica si el título se muestra correctamente
    expect(find.text('Curso P0'), findsOneWidget);
    ...
    // Verifica si el listado de alumnos se muestra correctamente
    expect(find.byType(Alumno), findsWidgets);
  });
