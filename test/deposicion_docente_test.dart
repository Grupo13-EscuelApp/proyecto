...
void main() {
  testWidgets('DepoDoc UI Test', (WidgetTester tester) async {
    ...
    await tester.enterText(find.byType(TextField).first, '08:00');
    await tester.enterText(find.byType(TextField).last, 'Pañal');
    ...
    // Verifica si la deposición añadida se muestra correctamente
